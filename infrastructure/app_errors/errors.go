...
var (
	...
	ErrYouAreUnableToPerformThisActionInResourceDiscardPhase               = NewBusinessRuleError("you-are-unable-to-perform-this-action-in-current-phase", "resource-discard-phase")
