module github.com/VulpesFerrilata/catan-service

go 1.18

require (
	github.com/VulpesFerrilata/go-micro/plugins/client/grpc/v3 v3.7.1-0.20220505060835-fcfc8ce5d7b9
	github.com/VulpesFerrilata/shared v0.0.0-20220409041017-530db115104a
